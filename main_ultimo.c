...

{
 ...
 static uint32_t cambiar_estado, tiempo, tiempo_2, estadoanterior_2, tiempo_3, estadoanterior_3, tiempo_4, estadoanterior_4;
 //char boton;
...
//			contador_2++;
//			if ((HAL_GPIO_ReadPin(GPIOA, COLUMNA_2)==0) && (contador_2>=80) && (cambiar_estado==1)){
//				cambiar_estado=0;
//			 	 contador_2=0;
//
//			 	if (CmdIndex == CMD_RECORD)
