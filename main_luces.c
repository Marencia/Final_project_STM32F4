...

{
 ...
 static uint8_t cambiar_estado,tiempo, cambiar_estado_f, tiempo_2, estadoanterior_2, tiempo_3, estadoanterior_3, tiempo_4, estadoanterior_4;
 //char boton;
 static uint32_t estadoanterior=0;
