...
__IO uint32_t Variable_de_estado = 0;
...
{ 
  ...
  while((AudioRemSize != 0) && (AppliState != APPLICATION_IDLE))//el problema de loopeo al reproducir se ecnuentra aquí porque no sale del while
  { 
    ...
    { 
      ...
      if(AudioRemSize > (AUDIO_BUFFER_SIZE / 2))// si lo que queda por reproducir es mayor a la mitad que se pasa a buffer para play, si es menor entonces es la ultima mitad que se pasa.
      {
  ...
  RepeatState = REPEAT_OFF;//cambia el estado de la variable de repeat
  /* Stop playing Wave */
  WavePlayerStop(); //para la reproduccion
  /* Close file */
  f_close(&FileRead);	//fijarme acá si es necesario porque cuando quiera volver a reproducir lo que grabé, volviendo a apretar, tal vez ya no tenga acceso al archivo.
  /* Test on the command: Playing */
  if(CmdIndex == CMD_PLAY)//pregunta si la variable está en play pero no reproduce... suspicius
  {
    LEDsState = LED4_TOGGLE;// este es el led que se enciende cuando queda a la espera de una nueva grabación
  }
#else 
  LEDsState = LEDS_OFF;
  RepeatState = REPEAT_ON;
...
if (indice==0){
  ...
  char path[] = "0:/"; //archivo de lectura
  char* wavefilename = NULL; //puntero de datos de archivo de lectura
  ...
  if(f_opendir(&Directory, path) == FR_OK)
  {
    ...
    if(f_open(&FileRead, wavefilename , FA_READ) != FR_OK)//que hace este if? Creo que pregunta si terminó de leer el archivo
    {
      //BSP_LED_On(LED5);
     // CmdIndex = CMD_RECORD;// no debería estar en CMD_Pause o stop o algo así?
    }
    else
    {    
...
if (indice==1){
  UINT bytesread = 0; //cantidad de bytes leidos
  char path[] = "1:/"; //archivo de lectura
  char* wavefilename = NULL; //puntero de datos de archivo de lectura
  WAVE_FormatTypeDef waveformat;
...
if (indice==2){
  UINT bytesread = 0; //cantidad de bytes leidos
  char path[] = "2:/"; //archivo de lectura
  char* wavefilename = NULL; //puntero de datos de archivo de lectura
  WAVE_FormatTypeDef waveformat;
...
if (indice==3){
  UINT bytesread = 0; //cantidad de bytes leidos
  char path[] = "3:/"; //archivo de lectura
  char* wavefilename = NULL; //puntero de datos de archivo de lectura
  WAVE_FormatTypeDef waveformat;
...
if (indice==4){
  UINT bytesread = 0; //cantidad de bytes leidos
  char path[] = "4:/"; //archivo de lectura
  char* wavefilename = NULL; //puntero de datos de archivo de lectura
  WAVE_FormatTypeDef waveformat;
...
if (indice==5){
  UINT bytesread = 0; //cantidad de bytes leidos
  char path[] = "5:/"; //archivo de lectura
  char* wavefilename = NULL; //puntero de datos de archivo de lectura
  WAVE_FormatTypeDef waveformat;
...
if (indice==6){
  UINT bytesread = 0; //cantidad de bytes leidos
  char path[] = "6:/"; //archivo de lectura
  char* wavefilename = NULL; //puntero de datos de archivo de lectura
  WAVE_FormatTypeDef waveformat;
...
if (indice==7){
  UINT bytesread = 0; //cantidad de bytes leidos
  char path[] = "7:/"; //archivo de lectura
  char* wavefilename = NULL; //puntero de datos de archivo de lectura
  WAVE_FormatTypeDef waveformat;
...
if (indice==8){
  UINT bytesread = 0; //cantidad de bytes leidos
  char path[] = "8:/"; //archivo de lectura
  char* wavefilename = NULL; //puntero de datos de archivo de lectura
  WAVE_FormatTypeDef waveformat;
...
if (indice==9){
  UINT bytesread = 0; //cantidad de bytes leidos
  char path[] = "9:/"; //archivo de lectura
  char* wavefilename = NULL; //puntero de datos de archivo de lectura
  WAVE_FormatTypeDef waveformat;
...
if (indice==10){
  UINT bytesread = 0; //cantidad de bytes leidos
  char path[] = "10:/"; //archivo de lectura
  char* wavefilename = NULL; //puntero de datos de archivo de lectura
  WAVE_FormatTypeDef waveformat;
...
if (indice==11){
  UINT bytesread = 0; //cantidad de bytes leidos
  char path[] = "11:/"; //archivo de lectura
  char* wavefilename = NULL; //puntero de datos de archivo de lectura
  WAVE_FormatTypeDef waveformat;
...
if (indice==12){
  UINT bytesread = 0; //cantidad de bytes leidos
  char path[] = "12:/"; //archivo de lectura
  char* wavefilename = NULL; //puntero de datos de archivo de lectura
  WAVE_FormatTypeDef waveformat;
...
if (indice==13){
  UINT bytesread = 0; //cantidad de bytes leidos
  char path[] = "13:/"; //archivo de lectura
  char* wavefilename = NULL; //puntero de datos de archivo de lectura
  WAVE_FormatTypeDef waveformat;
...
if (indice==14){
  UINT bytesread = 0; //cantidad de bytes leidos
  char path[] = "14:/"; //archivo de lectura
  char* wavefilename = NULL; //puntero de datos de archivo de lectura
  WAVE_FormatTypeDef waveformat;
...
if (indice==15){
  UINT bytesread = 0; //cantidad de bytes leidos
  char path[] = "15:/"; //archivo de lectura
  char* wavefilename = NULL; //puntero de datos de archivo de lectura
  WAVE_FormatTypeDef waveformat;
